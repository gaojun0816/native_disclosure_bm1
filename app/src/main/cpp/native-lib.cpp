...
Java_lu_uni_jungao_bm1_NativeDelegator_sStringFromJNI(
        JNIEnv *env,
        jclass /* cls */) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_lu_uni_jungao_bm1_NativeDelegator_iStringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_lu_uni_jungao_bm1_NativeDelegator_nativeSendSMS(JNIEnv *env, jobject /*this*/, jstring msg) {
    jclass MiddleCls = env->FindClass("lu/uni/jungao/bm1/MiddleCls");
...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass c = env->FindClass("lu/uni/jungao/bm1/NativeDelegator");
